...
genApp.controller("generationCtr", function($scope, $http, sweet) {
	...
	$scope.addGeneration = function() {
		...
		$http.post("http://localhost:8080/rest/generation", genData).success(function(response) {
			$scope.getGeneration();	
	...
	$scope.getGenerationById = function(id) {
		$http.get("http://localhost:8080/rest/generation/"+id).then(function(response) {
	...
	$scope.updateGeneration = function() {
		...
		$http.put("http://localhost:8080/rest/generation", updateData).success(function(response) {
			$scope.getGeneration();	
	...
	$scope.disableGeneration = function(id) {
		sweet.show({
            ...
            $http.put("http://localhost:8080/rest/generation/"+id, disableGen).success(function(response) {
